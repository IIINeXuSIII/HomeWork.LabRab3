...
void Search(string name, List<Teacher> teachers, List<Student> students)
{
    bool flag = false;
    foreach (Teacher teacher in teachers)
    {
        ...
        {
            Console.WriteLine($"{teacher.Name} - преподаватель");
            flag = true;
        }
    }
    foreach (Student student in students)
    {
        ...
        {
            Console.WriteLine($"{student.Name} студент {student.course.NumbOfCourse} курса");
            flag = true;
        }
    }
    if (flag == false)
    {
        Console.WriteLine("Поиск неудачен");
    }
}
...
abstract class User
{
    ...
    public virtual void GetInfo(List<Discipline> disciplines)
    {
        Console.WriteLine(); //Да какая разница что тут написано. Один хрен в классах
        //Студентов и Учителей функция перезапишется..
    }
...
class Student : User
{
    ...
    public override void GetInfo(List<Discipline> disciplines)
    {
...
class Teacher : User
{
    ...
    public override void GetStatus()
    {
        Console.WriteLine("а для преподавателя, что это преподаватель обучает");
    }
}
...
class Discipline : Course
{
    ...
    {
        Console.WriteLine($"Название дисциплины: {NameOfDiscipline}, " +
